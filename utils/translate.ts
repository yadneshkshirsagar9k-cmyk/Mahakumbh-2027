...
const DICTIONARY: Record<string, Record<string, string>> = {
  English: {
    ...
    'family_tracking': 'Family Tracking Map',
    'smart_route_map': 'Smart Route Map',
  ...
  Hindi: {
    ...
    'family_tracking': 'परिवार ट्रैकिंग मानचित्र',
    'smart_route_map': 'स्मार्ट रूट मैप',
  ...
  Marathi: {
    ...
    'family_tracking': 'कुटुंब ट्रॅकिंग नकाशा',
    'smart_route_map': 'स्मार्ट मार्ग नकाशा',
    'volunteer_portal': 'स्वयंसेवक पोर्टल',
