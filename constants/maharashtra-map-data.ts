...
export const MAHARASHTRA_DISTRICTS: MHDistrict[] = [
...

  {
    ...
    interestingFact: 'Nashik is one of the four sacred Kumbh Mela sites in India. It is famous for the holy Ramkund Ghat where Lord Rama performed rituals during his exile, and Tapovan, the sacred forest where Lakshmana cut Surpanakha\'s nose.',
    templeCount: 342,
    majorAttractions: ['Trimbakeshwar Jyotirlinga', 'Ramkund Sacred Ghat', 'Panchavati & Sita Gufaa', 'Anjaneri Hill (Hanuman Birthplace)', 'Saptashrungi Devi Mandir'],
    ...
    images: [
      ...
      { title: 'Panchavati & Sita Gufaa', subtitle: 'The holy grove where Lord Rama, Sita, and Lakshmana lived during exile', gradientStyle: 'linear-gradient(135deg,#b45309,#d97706,#f59e0b)', category: 'Pilgrimage', imageUrl: '/assets/images/temples/trimbakeshwar_angle.jpg' },
...

  {
    ...
    division: 'Chh. Sambhajinagar',
    headquarters: 'Jalna',
    description: 'A trading hub on the Marathwada plateau, Jalna is India\'s certified seed capital and an ancient Yadava dynasty town. It\'s connected to Chhatrapati Sambhajinagar\'s heritage circuit and has important local shrines.',
